...
from agents.schemas import GoalState, ManagerDecision, SubTask, WorldModel, WorldModelPatch
...
async def test_goal_manager_with_memory_and_critic():
    ...
    # It thoughts, identifies gaps, updates domains/beliefs, and spawns one subtask
    decision_1 = {
        "choices": [
            {
                "message": {
                    ...
                    "content": json.dumps({
                        ...
                        "tasks_to_spawn": [
                            {"goal": "Find the definition of gravity", "context": "None"}
                        ],
